...
async function main() {
  ...
  // 2. Seed Programmes
  const programmes = await db.programme.createMany({
    data: [
      {
        name: 'Pengagihan Bantuan Makanan Bulanan',
        description: 'Program pengagihan bungkusan makanan bulanan kepada keluarga asnaf di kawasan Hulu Klang, Taman Permata, Taman Melawati, Kg Fajar dan Klang Gate.',
        category: 'food-aid',
        status: 'active',
        startDate: new Date('2021-09-01'),
        location: 'Hulu Klang, Taman Permata, Taman Melawati, Kg Fajar, Klang Gate',
        beneficiaryCount: 1200,
        volunteerCount: 45,
        budget: 180000,
        actualCost: 165000,
        partners: JSON.stringify(['Jaya Grocer', 'Free Food Society', 'Perumahan Kinrara Berhad']),
        notes: 'Program flagship PUSPA - 15 lokasi pengagihan'
      },
      {
        name: 'Misi Tuisyen Sincerely Setia',
        description: 'Program tuisyen percuma untuk kanak-kanak asnaf meliputi Bahasa Melayu, Bahasa Inggeris, Matematik dan kemahiran hidup.',
        category: 'education',
        status: 'completed',
        startDate: new Date('2023-02-20'),
        endDate: new Date('2023-03-02'),
        location: 'Dewan Serbaguna MPAJ, Gombak',
        beneficiaryCount: 85,
        volunteerCount: 50,
        budget: 45000,
        actualCost: 42000,
        partners: JSON.stringify(['S P Setia Foundation', 'Perumahan Kinrara Berhad']),
        notes: 'Kadar lulus 95%'
      },
      {
        name: 'Program Literasi Kewangan',
        description: 'Program kesedaran kewangan untuk asnaf berkaitan pengurusan kewangan, simpanan dan perancangan masa depan.',
        category: 'financial',
        status: 'completed',
        ...
        budget: 30000,
        actualCost: 28000,
        partners: JSON.stringify(['S P Setia Foundation', 'Lembaga Zakat Selangor', 'ASNB', 'AKPK', 'Perumahan Kinrara Berhad']),
        notes: 'RM300 zakat per pax, RM80 bakul'
      },
      {
        name: 'Ramadan Mubarak dengan Asnaf',
        description: 'Program sempena Ramadan bersama kanak-kanak dan keluarga asnaf termasuk pengagihan langsir dan jamuan.',
        category: 'community',
        status: 'completed',
        startDate: new Date('2023-04-15'),
        endDate: new Date('2023-04-15'),
        location: 'Masjid Al Hidayah, Taman Melawati',
        beneficiaryCount: 162,
        volunteerCount: 20,
        budget: 35000,
        actualCost: 33000,
        partners: JSON.stringify(['S P Setia Foundation', 'Perumahan Kinrara Berhad', 'Kloth Cares']),
        notes: '122 set langsir diagihkan, 40 kanak-kanak'
      },
      {
        name: 'Pengagihan Zakat Tahunan',
        description: 'Program penyerahan zakat tahunan kepada asnaf yang layak di kawasan operasi PUSPA.',
        category: 'financial',
        status: 'active',
        startDate: new Date('2022-04-30'),
        location: 'Masjid Lama Al Hidayah, Taman Melawati',
        beneficiaryCount: 200,
        volunteerCount: 30,
        budget: 100000,
        actualCost: 95000,
        partners: JSON.stringify(['Lembaga Zakat Selangor']),
        notes: 'Program tahunan sempena Ramadhan'
      },
      {
        name: 'Program Latihan Kemahiran',
        description: 'Program latihan kemahiran untuk golongan asnaf termasuk kemahiran digital, kraftangan dan keusahawanan.',
        category: 'skills',
        status: 'active',
        ...
        budget: 75000,
        actualCost: 60000,
        partners: JSON.stringify(['S P Setia Foundation']),
        notes: '12 kursus disediakan, kadar kejayaan pekerjaan 70%'
      },
      {
        name: 'Program Sokongan Kesihatan',
        description: 'Program pemeriksaan kesihatan percuma dan konsultasi doktor untuk keluarga asnaf secara sukarela.',
        category: 'healthcare',
        status: 'active',
        startDate: new Date('2022-01-01'),
        location: 'Pelbagai lokasi di Hulu Klang & Gombak',
        beneficiaryCount: 2000,
        volunteerCount: 25,
        budget: 120000,
        actualCost: 100000,
        partners: JSON.stringify(['Klinik Kesihatan Kerajaan', 'Doktor Sukarela']),
        notes: '25+ doktor sukarela, pemeriksaan sukarela'
      },
      {
        name: 'Program Bantuan Sekolah',
        description: 'Pemberian bantuan buku, alat tulis dan pakaian sekolah kepada anak-anak asnaf sempena sesi persekolahan baru.',
        category: 'education',
        status: 'active',
        startDate: new Date('2023-01-01'),
        location: 'Taman Melawati & Taman Permata',
        beneficiaryCount: 350,
        volunteerCount: 15,
        budget: 50000,
        actualCost: 45000,
        partners: JSON.stringify(['Perumahan Kinrara Berhad']),
        notes: 'Semua peringkat sekolah'
      },
    ]
  });
  console.log(`✅ Seeded ${programmes.count} programmes`);
  ...
  // 3. Seed Donations
  const donations = await db.donation.createMany({
    data: [
      ...
      { donorName: 'Hj Razak bin Daud', donorEmail: 'razak@gmail.com', amount: 5000, method: 'bank-transfer', status: 'confirmed', date: new Date('2023-03-01'), programmeId: null, notes: 'Sumbangan individu' },
      { donorName: 'Pn Siti Hawa binti Ahmad', donorEmail: 'siti.hawa@gmail.com', amount: 2400, method: 'online', status: 'confirmed', date: new Date('2023-01-01'), programmeId: null, notes: 'Sumbangan bulanan RM200 x 12 bulan' },
      ...
      { donorName: 'Hj Razak bin Daud', donorEmail: 'razak@gmail.com', amount: 5000, method: 'bank-transfer', status: 'confirmed', date: new Date('2023-09-01'), programmeId: null, notes: 'Sumbangan individu - Q3' },
      { donorName: 'Pn Siti Hawa binti Ahmad', donorEmail: 'siti.hawa@gmail.com', amount: 1200, method: 'online', status: 'pending', date: new Date('2024-01-01'), programmeId: null, notes: 'Sumbangan bulanan 2024' },
      { donorName: 'Donor Anonimus', donorEmail: '', amount: 3000, method: 'cash', status: 'confirmed', date: new Date('2023-12-01'), programmeId: null, notes: 'Sumbangan tanpa nama' },
    ]
  });
  console.log(`✅ Seeded ${donations.count} donations`);
  ...
  const programmeMembersData = [
    // Food aid - all asnaf as beneficiaries
    ...asnafMembers.map(m => ({
    ...
    // Tuition - some asnaf and volunteers
  ...
  console.log(`✅ Seeded ${programmeMembersData.length} programme members`);
  ...
  const totalProgrammes = await db.programme.count();
